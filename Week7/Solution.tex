	...
	\section{Octave Problems}
		\subsection{Part 1.}
			\subsubsection{Question}
				...
				\end{enumerate}
			\subsubsection{Solution}	
				\lstinputlisting{./octave-solutions/Task1.m}
				\pagebreak
		\subsection{Part 2.}
			\subsubsection{Question}
			...
			\subsubsection{Solution}
				\lstinputlisting{./octave-solutions/Task2.m}
		\subsection{Part 3.}
			\subsubsection{Question}
			...
			\subsubsection{Solution}
				\lstinputlisting{./octave-solutions/Task3.m}
				\pagebreak
		\subsection{Part 4.}
			\subsubsection{Question}
		...
		\subsection{Part 5.}
			...
			\subsubsection{Solution}
				\miniHeader{Task5.m}
				\lstinputlisting{./octave-solutions/Task5/Task5.m}
				
				\noindent \rule{\textwidth}{0.5pt} \miniHeader{EvenSum.m}
				\lstinputlisting{./octave-solutions/Task5/EvenSum.m}
...
for r=1:1:2*rows
	for c=1:1:2*cols
		...
		\subsection{Part 8.}
			...
			\subsubsection{Solution}
				\lstinputlisting{./octave-solutions/Task8.m}
		\pagebreak
		\subsection{Part 9.}
			\subsubsection{Question}
			...
			\subsubsection{Solution}
				\lstinputlisting{./octave-solutions/Task9.m}
\end{document}